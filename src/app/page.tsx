...
export default function Home() {
 ...
 {/* Mint Section Styled Like Provided Image */}
      <div id="mint" className="w-full flex justify-center px-4 mt-10">
        <div className="w-full max-w-3xl bg-black bg-opacity-40 border-[4px] border-akatsukiRed rounded-[10px] p-6 text-white backdrop-blur-lg flex flex-col items-center gap-6">

  ...
  return (
    <div className='w-full bg-[#000] font-ShPinscher'>
        ...
        <div className='w-full flex flex-col justify-center items-center relative'>
            <div className='w-5/6 flex justify-between mt-8 h-[40px]'>
                <div className='flex gap-2'>
                    <ScholashipBtn content = "Mint your exclusive membership" url = "/" />
                    <div className='hidden md:flex'>
                        <WalletMultiButton style={{color: '#FFFFFF', height: "32px", border: "1px solidrgb(186, 19, 25)", borderRadius: "10px", backgroundColor: "transparent", fontSize: '15px', fontFamily: "SHPinscher, sans-serif'"}} />
                    </div>
                </div>
                ...
                <div className='hidden md:flex justify-between gap-6 text-white text-content'>
                    ...
                    <a href="/public/img/Akatsuki-wp.pdf" target="_blank" rel="noopener noreferrer" className='hover:border-b-4 hover:border-[#FF0000] pb-1 duration-200'>
                     Whitepaper
                    </a>
                </div>
                <div
                    onClick={() => setOpen(!isOpen)}
                    className='flex md:hidden justify-center items-center bg-white p-3 rounded-[10px] border-[1px] border-AkatsukiRed w-[32] sm:w-[50px] text-black hover:bg-White cursor-pointer'
                >
        ...
        <div className='w-full flex flex-col justify-between items-center gap-15 pb-14'>
            <div className='w-5/6 md:w-1/3 border-[6px] ro unded-2xl border-[#BA1319] bg-bgColor flex flex-col gap-4 items-center p-4 pb-8 mt-8'>
                <div className='text-title text-white text-center gap-6 w-full'>Akatsuki <span className = "text-border-[#BA1319]">#{itemsMinted}/{itemsAvailable}</span></div>
                {soldOut == true && 
                ...
                <div className = "relative">
                  ...
                  {soldOut == false && 
                    <div className='w-full absolute bottom-[-30px] flex items-center justify-center' onClick={() => onMint()}>
                      ...
                      ): <p className='text-border: "1px solid #BA1319" text-title py-3 px-4 border-[3px] border-border: "1px solid #BA1319" bg-bgColor rounded-full' >Mint Coming Soon</p>}
                    </div>
                  }
                          ...
                          <div className='flex flex-col items-center justify-center w-full h-full gap-6'>
                              <div className='flex flex-row items-center justify-between w-full h-full px-3 text-white md2:px-10' >
                                  <div
                                      ...
                                      ? 'cursor-not-allowed'
                                      : 'cursor-pointer'  
                                      } w-[60px] h-[60px] flex flex-row rounded-full bg-[#BA1319] items-center justify-center hover:bg-[#8B0000]`
                                      }
                                  >
                              ...
                              <p className = "text-border-AkatsukiRed text-content" ><span className = "text-[#ff0000]">Requirement</span>: {MINT_STATES[mintState].solPrice} SOL {mintState ==='OG'? ' + 1X WL1 Token':mintState === 'WL'? ' + 1X WL2 Token':''}</p>
                          </div>
                      )}
                  </div>
                }
